    ...
    <div id="content" class="clearfix">
        ...
        <div id="main">
              ...
              <div class="primary">
                ...
                <p class="post-info"><span>Vous cherchez un auteur...</span></p>
                ...
                if(isset($_GET['qsearch'])) {
                    ...
                    // 根据搜索参数查询作者表
                    $req = "SELECT IdAuteur, nomAuteur, prenomAuteur FROM Auteur WHERE LOWER(nomAuteur) = LOWER('%$searchTerm%');";
                    ...
                    if ($row = mysqli_fetch_array($res)) {
                        ...
                        echo "Nous n'avons pas trouvé l'auteur' que vous recherchiez";
                    }
                } 
                ...
                echo '<p><a href="auteur1.php"> Retour à la page de l\'auteur </a></p>';
                ?>
